...
{
    protected static $defaultName = 'Arrival';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($input->getOption('display')) {
            ...
            $time=time()-3600;
            $time2=time();
            $url="https://chema969:Chema957081430@opensky-network.org/api/flights/arrival?airport=LEMD&begin=" .$time. "&end=" .$time2;
            var_dump($url);
            ...
            $ehe=(count($datos));
            $message="Han aterrizado en la ultima hora " . $ehe . " vuelos.";
